...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($_POST['level_user'] == 'sales') {
        if (isset($_POST['id_gudang'])) {
            ...
            $insertVisit = mysqli_query($conn, "INSERT INTO tb_visit(id_contact,distance_visit,laporan_visit,source_visit,id_user,is_manual) VALUES($id_gudang, $distance_visit, '$laporan_visit', '$source', $id_user,1)");
            ...
            $insertVisit = mysqli_query($conn, "INSERT INTO tb_visit(id_contact,distance_visit,laporan_visit,source_visit,id_user,is_manual) VALUES($id_contact, $distance_visit, '$laporan_visit', '$source', $id_user,1)");
            $id_visit = mysqli_insert_id($conn);
    ...
    } else if ($_POST['level_user'] == 'courier') {
        $id_gudang = $_POST['id_gudang'] ? $_POST['id_gudang'] : 0;
        $distance_visit = $_POST['distance_visit'] ? str_replace(',', '.', $_POST['distance_visit']) : 0;
        $laporan_visit = $_POST['laporan_visit'] ? $_POST['laporan_visit'] : '';
        $id_user = $_POST['id_user'] ? $_POST['id_user'] : 0;

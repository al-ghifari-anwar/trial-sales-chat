...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if (isset($_POST['id'])) {
        ...
        $jam_bayar = isset($_POST['jam_bayar']) ? $_POST['jam_bayar'] : '00:00:00';

...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $checkKontak = mysqli_query($conn, "SELECT * FROM tb_contact WHERE nomorhp = '$nomor_hp' OR nomorhp_2 = '$nomor_hp'");
    ...
    if ($row == null) {
        ...
        $result = mysqli_query($conn, "SELECT * FROM tb_contact WHERE nomorhp = '$nomor_hp' OR nomorhp_2 = '$nomor_hp'");
